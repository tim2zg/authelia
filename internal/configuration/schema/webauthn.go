...
type WebAuthn struct {
	...
	AdditionalOrigins    []string `koanf:"additional_origins" yaml:"additional_origins,omitempty" toml:"additional_origins,omitempty" json:"additional_origins,omitempty" jsonschema:"title=Additional Origins" jsonschema_description:"Additional Relying Party origins for WebAuthn."`
...
type WebAuthnMetadata struct {
	...
	ValidateEntry                 bool `koanf:"validate_entry" yaml:"validate_entry" toml:"validate_entry" json:"validate_entry" jsonschema:"default=true,title=Validate Entry" jsonschema_description:"WebAuthn Authenticator metadata entry validation requires the AAGUID exists as a MDS3 registered entry."`
	ValidateEntryPermitZeroAAGUID bool `koanf:"validate_entry_permit_zero_aaguid" yaml:"validate_entry_permit_zero_aaguid" toml:"validate_entry_permit_zero_aaguid" json:"validate_entry_permit_zero_aaguid" jsonschema:"default=true,title=Validate Entry Permit Zero AAGUID" jsonschema_description:"WebAuthn Authenticator metadata entry validation zero AAGUID's can be skipped."`
