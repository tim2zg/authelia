...
// RevokeActiveSessionByID mocks base method.
func (m *MockStorage) RevokeActiveSessionByID(ctx context.Context, id string) error {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "RevokeActiveSessionByID", ctx, id)
	ret0, _ := ret[0].(error)
	return ret0
}

// RevokeActiveSessionByID indicates an expected call of RevokeActiveSessionByID.
func (mr *MockStorageMockRecorder) RevokeActiveSessionByID(ctx, id any) *gomock.Call {
	mr.mock.ctrl.T.Helper()
	return mr.mock.ctrl.RecordCallWithMethodType(mr.mock, "RevokeActiveSessionByID", reflect.TypeOf((*MockStorage)(nil).RevokeActiveSessionByID), ctx, id)
}
